...
/* Translate name of a service location and/or a service name to set of
   ...
   This function is a possible cancellation point and therefore not
   marked with __THROW.  */
extern int getaddrinfo (__const char NULLTERMSTR * NNSTRINGPTR __restrict __name,
			__const char NULLTERMSTR * NNSTRINGPTR __restrict __service,
			__const struct addrinfo * NNOK __restrict __req,
			struct addrinfo * NNOK *__restrict __pai) OKEXTERN;
